...
namespace Archery.Areas.BackOffice.Controllers
{
    public class TournamentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nom,Start,Finish,Location,MaxCapacity,Fee,Description")] Tournament tournament, int[] WeaponsID)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nom,Start,Finish,Location,MaxCapacity,Fee,Description")] Tournament tournament)
        {
            if (ModelState.IsValid)
            {
